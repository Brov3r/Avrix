...
set "javaArg=-Djava.awt.headless=true -Davrix.mode=client -Dzomboid.steam=%steamMode% -Dzomboid.znetlog=1 %javaOptions% -XX:-CreateCoredumpOnCrash -XX:-OmitStackTraceInFastThrow -Djava.library.path=%libraryPath% -cp %classPath%"
