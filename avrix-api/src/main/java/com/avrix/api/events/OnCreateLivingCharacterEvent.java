...
public abstract class OnCreateLivingCharacterEvent extends Event {
     ...
     */
    public abstract void handle(IsoPlayer playerOrSurvivor, SurvivorDesc survivorDesc);
     ...
     * @param survivorDesc     The survivor description of the player or survivor who's being created.
     */
    public abstract void handle(IsoSurvivor playerOrSurvivor, SurvivorDesc survivorDesc);
}
