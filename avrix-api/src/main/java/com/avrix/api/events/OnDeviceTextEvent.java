...
public abstract class OnDeviceTextEvent extends Event {
     ...
     */
    public abstract void handle(String interactCodes, Float x, Float y, Float z, String line, IsoWaveSignal device);
     ...
     * @param device        The media device that is displaying the text.
     */
    public abstract void handle(String interactCodes, Float x, Float y, Float z, String line, Radio device);
     ...
     * @param device        The media device that is displaying the text.
     */
    public abstract void handle(String interactCodes, Float x, Float y, Float z, String line, VehiclePart device);
}
